...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Parasite Eve",
    .project_root_env = "PARASITE_EVE_PROJECT_ROOT",
    .build_dir_env = "PARASITE_EVE_BUILD_DIR",
    .force_setup_env = "PARASITE_EVE_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_006.62_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Parasite_Eve",
    .prepare_note =
